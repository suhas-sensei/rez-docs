...
* L<sub>fetch</sub> is the number of candles fetched.
* N<sub>results</sub> is the number of indicator values the agent requested.
...
$$EMA_t = P_t \times \alpha + EMA_{t-1} \times (1 - \alpha)$$ $$\alpha = \frac{2}{period + 1}$$
